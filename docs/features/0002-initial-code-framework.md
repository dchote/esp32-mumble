...
- `__init__.py` — Component registration, YAML schema (server, port, username, password, channel, mode; optional entity IDs: server_text_id, port_text_id, username_text_id, password_text_id, channel_text_id, mode_select_id, crypto_select_id; microphone_id, speaker_id; ptt_pin, mute_pin, crypto)
